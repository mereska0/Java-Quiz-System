...
public class CardLearningPane extends StackPane {
    ...
    private void initializeUI() {
        ...
        relearnButton = new Button("retry");
    ...
    private void startLearning() {
        ...
        if (cardLearning.getIndex() >= cardLearning.currentSizeCards()) {
            if (cardLearning.sizeUndoneCards() > 0) {
                statusLabel.setText("left unknown: " + cardLearning.sizeUndoneCards());
    ...
    private void updateStatus() {
        statusLabel.setText(
                "progress: " + cardLearning.sizeDoneCards() + "/" + cardLearning.sizeCards() +
                        " | left: " + cardLearning.sizeUndoneCards()
        );
    }
